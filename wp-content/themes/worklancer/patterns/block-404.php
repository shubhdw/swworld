        ...
        <div class="wp-block-cover is-light" style="padding-bottom: var(--wp--preset--spacing--80); min-height: 400px">
            ...
            <div class="wp-block-cover__inner-container">
                ...
                <div class="wp-block-group">
                    <!-- wp:image {"align":"center","id":1454,"width":308,"height":146,"sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":["#000000","#00a5ff"]}}} -->
                    <figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url(get_stylesheet_directory_uri())  ?>/assets/images/404.png" alt="" class="wp-image-1454" width="308" height="146" /></figure>
                    <!-- /wp:image -->
                    ...
                    <h4 class="wp-block-heading has-text-align-center has-small-font-size" style="font-style: normal; font-weight: 300; letter-spacing: 4px; text-transform: uppercase"><?php echo esc_html__('OOPS! Page Not Found!', 'worklancer') ?></h4>
                    <!-- /wp:heading -->
                </div>
                <!-- /wp:group -->
            </div>
    ...
    <div class="wp-block-group" style="padding-top: var(--wp--preset--spacing--80); padding-right: var(--wp--preset--spacing--40); padding-bottom: var(--wp--preset--spacing--80); padding-left: var(--wp--preset--spacing--40)">
        ...
        <div class="wp-block-columns">
            ...
            <div class="wp-block-column" style="flex-basis: 60%">
                ...
                <h3 class="wp-block-heading has-text-align-left" style="font-style: normal; font-weight: 600"><?php echo esc_html__('Helpful Links', 'worklancer') ?></h3>
                <!-- /wp:heading -->

                <!-- wp:paragraph -->
                <p><?php echo esc_html__('Something went wrong! We couldn\'t find the page you were looking for. But don\'t worry, we\'ve got some other Links that might be helpful:', 'worklancer') ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:column -->
        ...
        <div class="wp-block-columns">
            ...
            <div class="wp-block-column">
                ...
                <h4 class="wp-block-heading" style="margin-bottom: var(--wp--preset--spacing--40)"><?php echo esc_html__('Pages', 'worklancer') ?></h4>
                <!-- /wp:heading -->
            ...
            <div class="wp-block-column">
                <!-- wp:heading {"level":4} -->
                <h4 class="wp-block-heading"><?php echo esc_html__('Categories', 'worklancer') ?></h4>
                <!-- /wp:heading -->
            ...
            <div class="wp-block-column">
                ...
                <div class="wp-block-group alignfull" style="border-bottom-style: none; border-bottom-width: 0px; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0">
                    <!-- wp:heading {"level":4} -->
                    <h4 class="wp-block-heading"><?php echo esc_html__('Latest Posts', 'worklancer') ?></h4>
                    <!-- /wp:heading -->
                </div>
                <!-- /wp:group -->
